...
urlpatterns = [
    ...
    path('503.html', auth_views.PasswordChangeView.as_view(template_name='503.html')),
    path('403.html', auth_views.PasswordChangeView.as_view(template_name='403.html')),
    path('404.html', auth_views.PasswordChangeView.as_view(template_name='404.html')),
